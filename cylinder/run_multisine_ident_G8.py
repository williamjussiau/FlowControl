...
def main(argv):
    ...
    params_time = {'dt': 0.005, # not recommended to modify dt between runs 
                  'dt_old': 0.005,
                  'restart_order': 1,
                  'Tstart': 4000, # start time of simulation # TODO 
                  'Trestartfrom': 3500, # last file to restart from # TODO
    ...
    params_save['savedir0'] = '/scratchm/wjussiau/fenics-results/cylinder_o1_ms_id_G8_{0}/'.format(file_nr) # TODO

    ## Amplitudes of sines (ampl<=2.0 better)
    ampl_list = np.array([0.00001]) # TODO
    ...
    Pskip = 2  # TODO # was 4 then 2 
    Psim = 4  # TODO # was 16 then 4
    # if not all freq, divide things
