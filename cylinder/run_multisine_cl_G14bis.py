...
def main(argv):
    ...
    if is_test:
        ...
        savedir0 = '/scratchm/wjussiau/fenics-results/cylinder_o1_ms_cl_G14bis/'
    ...
    params_time = {'dt': 0.005, # not recommended to modify dt between runs 
                   ...
                   'Tstart': 1500, # start of this sim # TODO # 1st switching/stacking iter is 1000
                   'Trestartfrom': 1000, # last restart file # TODO
                   'num_steps': 100000, #  
                   'Tc': 0} 
    ...
    ########### MODEL
    # TODO
    G = flu.read_ss(sspath + 'G14bis.mat') # TODO DONOTOUCH
    ...
    # here slowfast
#    Tlim = 6 # cut poles under Tlim response time
