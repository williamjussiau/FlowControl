...
def main(argv):
    ...
    params_save={'save_every': 10000, # was 2000 
    ...
    params_time = {'dt': 0.005, # not recommended to modify dt between runs 
                  'dt_old': 0.005,
                  'restart_order': 1,
                  'Tstart': 1500, # start time of simulation # TODO 
                  'Trestartfrom': 1000, # last file to restart from # TODO
    ...
    params_save['savedir0'] = '/scratchm/wjussiau/fenics-results/cylinder_o1_ms_id_' + str(file_nr) + '/' # TODO
