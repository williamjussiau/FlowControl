...
def main(argv):
    ...
    if is_test:
        ...
        #savedir0 = '/scratchm/wjussiau/fenics-results/cylinder_o1_ms_cl_G8bis_{0}/'.format(k_arg)
    ...
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter3/'
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter4/'
    ...
    ########### MODEL
    # TODO
    #G = flu.read_ss(sspath + 'G8.mat') # TODO DONOTOUCH
    #G = flu.read_ss(sspath + 'Gi14.mat') # TODO DONOTOUCH
    #G = flu.read_ss(sspath + 'G8A00001.mat') # TODO DONOTOUCH
    #Glist = ['G8A001.mat', 'G8A0001.mat', 'G8A00001.mat', 'G8A000001.mat']
    #Glist = ['GbestA001.mat', 'GbestA0001.mat', 'GbestA00001.mat', 'GbestA000001.mat']
    #G = flu.read_ss(sspath + Glist[k_arg-1])
    #G = flu.read_ss(sspath + 'G8A00001.mat') # TODO DONOTOUCH
    ...
    Qu = 10**(-2) # Qu low = low penalty on u = big u  = high feedback gain
    Qv = 10**(k_arg-5) # Qv low = low noise on y = follow y = high observation gain 
    ...
    x_ctrl_Kss0 = np.zeros(G.nstates,)
    #x_ctrl_Kss0 = np.hstack((x_ctrl0, np.zeros(G.nstates)))
