...
def main(argv):
    ...
    if is_test:
        ...
        savedir0 = '/scratchm/wjussiau/fenics-results/cylinder_o1_ms_cl_G14/'
    ...
    params_time = {'dt': 0.005, # not recommended to modify dt between runs 
                   ...
                   'Tstart': 6500, # start of this sim # TODO # 1st switching/stacking iter is 1000
                   'Trestartfrom': 6000, # last restart file # TODO
                   'num_steps': 100000, #  
                   'Tc': 0} 
    ...
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter4/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter5/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter6/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter7/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter8/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter9/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter10/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter11/' # TODO
    #sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter12/' # TODO
    sspath = '/scratchm/wjussiau/fenics-python/cylinder/data/o1/lco/tcfd/iter12/' # TODO
    ...
    ########### MODEL
    # TODO
    G = flu.read_ss(sspath + 'G14.mat') # TODO DONOTOUCH
    ...
    Qu = 10**(1) # Qu low = low penalty on u = big u  = high feedback gain
    Qv = 10**(1) # Qv low = low noise on y = follow y = high observation gain 
