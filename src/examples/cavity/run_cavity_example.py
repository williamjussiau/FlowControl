...
def main():
    ...
    params_time = flowsolverparameters.ParamTime(num_steps=10000, dt=0.0004, Tstart=0.0)
    params_save = flowsolverparameters.ParamSave(save_every=50, path_out=cwd / "data_output")
    ...
    params_ic = flowsolverparameters.ParamIC(xloc=2.0, yloc=0.0, radius=0.5, amplitude=0.1)
