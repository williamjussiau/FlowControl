...
class multisin_generator:
    ...
    def compute_harmonics(
        f0, N, Fs, fmin=0.0, fmax=1.0, skip_even=0, include_fbounds=1
    ):
...
if __name__ == "__main__":
    ...
    freqsin = multisin_generator.compute_harmonics(
        f0=f0, N=200, Fs=Fs, fmin=0.0, fmax=0.5, include_fbounds=False
    )
