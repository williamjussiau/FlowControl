...
//+
Curve Loop(7) = {6, -15, -14, -13, 8, -12, -11, -10};
//+
Plane Surface(1) = {7};
//+
Curve Loop(8) = {6, -15, -14, -13, 8, -12, -11, -10};
//+
Curve Loop(9) = {1};
//+
Plane Surface(2) = {8, 9};
//+
Delete {
  Point{8}; Point{7}; Point{5}; Point{6}; 
}
//+
Delete {
  Surface{1}; 
